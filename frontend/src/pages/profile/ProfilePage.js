...
const ProfilePage = () => {
  ...
  const {data: user, isLoading,refetch,isRefetching,} = useQuery({queryKey: ["userProfile", username],
        queryFn: async () => {
      try {
 ...
 const {updateProfile , isUpdatingProfile} = useUpdateUserProfile()
  ...
  const isMyProfile = authUser?._id === user?._id; // Ensure matching property names for IDs
